  ...
  return (
    <>
      <nav className="sm:px-2 mx-auto sm:px-2 container_xxl">
        <div className="flex flex-row items-center justify-between font-medium container mx-auto px-4 sm:px-4 2xl:max-w-8xl">
          <a
            className="inline-block pt-1 pb-1 mr-4 whitespace-no-wrap site_logo_light"
            href="a"
          >
          ...
          >
            <button
              type="button"
              className="btn-close text-reset shadow-none border-0 xl:hidden block mt-3 ms-3 me-auto"
            ...
            <ul className="flex flex-wrap list-reset pl-0 mb-0 navbar_nav2 lg:ml-4 sm:mx-auto mb-2 lg:mb-0 xl:mt-0 mt-5">
              ...
              <div className="relative">
                <button
                  ...
                  onClick={toggleMenu}
                >
                  <span className="font-semibold txt_white py-1 px-4">
                    Vision
                    <i class="fa fa-caret-down ml-2" aria-hidden="true"></i>
                  </span>
                </button>
                <div
                  className={`dropdown-menu flex flex-col justify-start items-start absolute right-0 mt-2 py-1 px-4 bg-black shadow-xl ${
                    isMenuOpen ? "" : "hidden"
                  }`}
                >
                  <a
                    className="block px-12 py-1 text-sm txt_white hover:bg-gray-100"
                    href="a"
                  >
                    Pools
                  </a>
                  <a
                    className="block px-1 py-1 text-sm txt_white hover:bg-gray-100"
                    href="a"
                  >
                    My Pools
                  </a>
                  <a
                    className="block px-4 py-1 text-sm txt_white hover:bg-gray-100"
                    href="a"
                  >
                    Farms NEW
                  </a>
